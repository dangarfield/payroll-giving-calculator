...
(function ($, undefined) {
	...
	/ -------------------------------------------------------------------------------- */
		...
		function isRetina() {
			var retinaMediaQuery = '(-webkit-min-device-pixel-ratio: 2),\
			...
			for (var x=0;x<retinaReadyImageList.length;x++) {
				...
				if ($.inArray(RetinaImageFileName+'@2x'+RetinaImageFileExt ,retinaImageList)>-1) { 
					...
					$retinaReadyImages.each(function(index, element) {
						...
						var RetinaImageW = this.naturalWidth;
						var RetinaImageH = this.naturalHeight;
						if (this.src==RetinaImageFileName+RetinaImageFileExt) {
							this.src=RetinaImageFileName+'@2x'+RetinaImageFileExt;
							this.style.width=RetinaImageW+'px';
							this.style.height=RetinaImageH+'px';
						};
					});
				} else {
	...
	/ -------------------------------------------------------------------------------- */		
		...
		function DoMagnificPopup() {
			if (jQuery().magnificPopup) {
				$portfolio.each(function(index, element) {
					var $this = $(this);
					portfolioGallery[$this.data('id')] = $this.find('.gw-gopf-magnific-popup, .gw-gopf-magnific-popup-html').magnificPopup({
						type : 'image',
		...
		function updatePopupGallery( portfolioId ) {
			var $galleryItems = $portfolio.filter('[data-id="'+portfolioId+'"]').find('.gw-gopf-magnific-popup, .gw-gopf-magnific-popup-html');
